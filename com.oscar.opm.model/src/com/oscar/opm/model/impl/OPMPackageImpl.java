...
public class OPMPackageImpl extends EPackageImpl implements OPMPackage {
	...
	public EAttribute getOPMNode_Constraints() {
		return (EAttribute)opmNodeEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getOPMNode_OutgoingLinks() {
		return (EReference)opmNodeEClass.getEStructuralFeatures().get(3);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getOPMNode_Constraints(), this.getRectangle(), "constraints", "", 0, 1, OPMNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
